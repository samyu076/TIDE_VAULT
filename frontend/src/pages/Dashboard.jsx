            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-8 h-[400px] glass-card overflow-hidden relative">
                    ...
                    >
                      ...
                      <Polyline
                        positions={[
                          [19.135, 72.795], [19.13637, 72.7948], [19.13755, 72.79387], [19.13895, 72.79378], [19.14027, 72.7934], [19.14172, 72.79356], [19.14304, 72.79317], [19.14443, 72.79305], [19.14557, 72.79193], [19.14698, 72.79192], [19.14822, 72.79121], [19.1496, 72.79106], [19.151, 72.79101], [19.15222, 72.79021], [19.15359, 72.79004], [19.155, 72.79]
                        ]}
                        pathOptions={{ color: '#F87171', weight: 4, opacity: 0.9 }}
                      />
                      <Polyline
                        positions={[
                          [19.195, 72.773], [19.19668, 72.77302], [19.19836, 72.77291], [19.20003, 72.77302], [19.20169, 72.77323], [19.20331, 72.77398], [19.20502, 72.7735], [19.20668, 72.77379], [19.20832, 72.77429], [19.21, 72.77425], [19.21162, 72.77486], [19.21333, 72.77445], [19.21501, 72.77451], [19.21666, 72.77487], [19.21836, 72.77453], [19.22, 72.775]
                        ]}
                        pathOptions={{ color: '#F87171', weight: 4, opacity: 0.9 }}
                      />
                      ...
                      <Polyline
                        positions={[
                          [19.135, 72.795], [19.13615, 72.79395], [19.13774, 72.79464], [19.13886, 72.79345], [19.14032, 72.79361], [19.14173, 72.7936], [19.14311, 72.79345], [19.14432, 72.79259], [19.14567, 72.79233], [19.14681, 72.79125], [19.14831, 72.79156], [19.14962, 72.79114], [19.15114, 72.79155], [19.15235, 72.79074], [19.15377, 72.79073], [19.155, 72.79]
                        ]}
                        pathOptions={{ color: '#2DD4BF', weight: 4, opacity: 0.9, dashArray: '8 4' }}
                      />
                      <Polyline
                        positions={[
                          [19.195, 72.773], [19.19672, 72.77243], [19.19834, 72.77318], [19.19996, 72.77394], [19.20163, 72.77394], [19.2033, 72.77413], [19.20501, 72.77367], [19.20662, 72.77453], [19.20833, 72.77413], [19.21007, 72.77336], [19.21167, 72.77425], [19.21341, 72.77357], [19.21493, 72.77546], [19.2166, 72.77562], [19.21836, 72.77454], [19.22, 72.775]
                        ]}
                        pathOptions={{ color: '#2DD4BF', weight: 4, opacity: 0.9, dashArray: '8 4' }}
                      />
                    
                      <Marker position={[19.135, 72.795]} icon={createCustomIcon('#1a9e8f')}>
                        <Popup><div className="font-mono text-xs"><b>A_2011</b><br/>Location A • Site 2</div></Popup>
                      </Marker>
                      <Marker position={[19.155, 72.79]} icon={createCustomIcon('#1a9e8f')}>
                        <Popup><div className="font-mono text-xs"><b>A_2019</b><br/>Location A • Site 2</div></Popup>
                      </Marker>
                      <Marker position={[19.145, 72.792]} icon={createCustomIcon('#c9a84c')}>
                        <Popup><div className="font-mono text-xs"><b>A_Boundary</b><br/>Location A • Site 2</div></Popup>
                      </Marker>
                      <Marker position={[19.195, 72.773]} icon={createCustomIcon('#1a9e8f')}>
                        <Popup><div className="font-mono text-xs"><b>C_2011</b><br/>Location B • Site 1</div></Popup>
                      </Marker>
                      <Marker position={[19.22, 72.775]} icon={createCustomIcon('#1a9e8f')}>
                        <Popup><div className="font-mono text-xs"><b>C_2019</b><br/>Location B • Site 1</div></Popup>
                      </Marker>
                      <Marker position={[19.207, 72.774]} icon={createCustomIcon('#c9a84c')}>
