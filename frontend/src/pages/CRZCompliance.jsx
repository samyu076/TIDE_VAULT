                    ...
                    <div className="glass-card p-0 overflow-hidden">
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            <button 
                                onClick={async () => {
                                    try {
                                        // Trigger real PDF generation for the active site
                                        // We use Location A or B based on active visibility
                                        const siteId = activeZone === 'CRZ-IA' ? 'location_a' : 'location_b';
                                        const response = await axios.get(`http://localhost:8000/api/crz/${siteId}/export/pdf`, {
                                            responseType: 'blob',
                                            timeout: 15000
                                        });
                                        ...
                                        link.href = url;
                                        link.setAttribute('download', `TideVault_Executive_Audit_${siteId.toUpperCase()}.pdf`);
                                        ...
                                        alert("Failed to generate PDF Report. Ensure backend is running with fpdf2 installed.");
                                    }
                                }}
                            ...
                            >
                                <FileText size={12} />
                                <span>DOWNLOAD CRZ COMPLIANCE REPORT (PDF)</span>
                            </button>
                        </div>
                    </div>
                </div>
